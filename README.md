...
| **ZRAM Swap Configurator v4.0** | Interactive WebUI fork ([3 releases](https://github.com/abr60/my-ksu-module-kit/releases)) | Rei Ryuki (The Fixer) / https://github.com/reiryuki/ZRAM-Swap-Configurator-Magisk-Module (MIT) — WebUI fork by abr60 | 
